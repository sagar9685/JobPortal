                                ...
                                <div class="select-Categories pt-80 pb-50">
                                    ...
                                    <div class="checkbox checkbox-primary">
                                        <asp:CheckBoxList ID="CheckBoxList1" runat="server" AutoPostBack="True"
                                            ...
                                            <asp:ListItem Text="FullTime">FullTime</asp:ListItem>
                                            <asp:ListItem Text="PartTime">PartTime</asp:ListItem>
                                            <asp:ListItem Text="Remote">Remote</asp:ListItem>
                                            <asp:ListItem Text="Freelance">Freelance</asp:ListItem>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="section-tittle mb-30">
                                            <h3>Featured Jobs</h3>
                                            <span class="number" id="lbljobCount" runat="server"></span>
                                        </div>
                                    </div>
                                </div>
